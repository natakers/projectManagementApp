...
const SignupPage = (props: Props) => {
  ...
  return (
    <section className='signup-page w-full px-6 py-6 flex flex-col justify-center items-center gap-16'>
      <div className="logo__container w-full flex flex-col justify-center items-center gap-3">
        <h1 className="logo">Some Logo</h1>
        <p className="title text-center font-bold text-3xl text-gray-900">Join our community</p>
      </div>
      <form onSubmit={onSubmit} className="form w-1/4 flex flex-col justify-center items-center gap-6">
        ...
        <div className="form__item w-full flex justify-center">
          <button type='submit' className='form__button w-full px-4 py-2 text-lg border-transparent rounded-md shadow-md font-medium text-white bg-indigo-600 hover:bg-indigo-700 transition-all duration-200'>Sign Up</button>  
        </div>
      </form>
